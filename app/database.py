...
class API_Mensajeria(object):
    ...
    def conecta(self):
            ...
            # Cargar la variable DATABASE_URL desde las variables de entorno
        ...
        # Extraer los valores
        DB_HOST = db_url.hostname or "localhost" # equivalente al localhost para Docker (para poder acceder al mysql local del equipo)
        DB_USER = db_url.username or "root"
        DB_PASSWORD = db_url.password or ""
        DB_NAME = db_url.path.lstrip("/") or "whatsapp2425" 
        DB_PORT = db_url.port or 3306  # Si no se especifica el puerto, usa 3306
